...
describe "Pokemon" do
  ...
  describe "BONUS" do
    ...
    xit "knows that a pokemon have a default hp of 60" do
      ...
      # remember to also update the CREATE TABLE IF NOT EXISTS pokemon(id INTEGER PRIMARY KEY, name TEXT, type TEXT); method to accept an argument of hp that defaults to nil if not set (so it still passes the non-bonus tests)
